...
import (
	...
	"NTG/web/templates/pages/professional_education"
	"net/http"

	"github.com/a-h/templ"
)

func ProfessionalEducation() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		templ.Handler(professional_education.Handler(page, language, phrases)).ServeHTTP(w, r)
	})
}
